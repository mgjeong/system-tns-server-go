...
echo -e "\n\033[33m"Start building of Topic Naming Space server"\033[0m"
export GOPATH=$PWD
...
echo -ne "\nMaking executable file of Topic Naming Space server"
build
echo ": Done"
...
echo -e "\n\033[33m"Succeed build of Topic Naming Space server"\033[0m"
