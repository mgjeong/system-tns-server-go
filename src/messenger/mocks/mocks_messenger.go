...
func (m *MockCommand) SendHttpRequest(method, url string, dataOptional ...[]byte) (int, string, error) {
...
func (mr *MockCommandMockRecorder) SendHttpRequest(method, url interface{}, dataOptional ...interface{}) *gomock.Call {
